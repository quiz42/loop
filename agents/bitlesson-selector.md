...
You select which lessons from the configured BitLesson file, normally `.loop/bitlesson.md`, must be applied for a given sub-task.
...
- Related file paths
- The project BitLesson content from the configured file, normally `.loop/bitlesson.md`
