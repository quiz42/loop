...
Before the loop fully exits, please perform a methodology improvement analysis. This analysis helps improve the Loop development methodology itself -- it is NOT about the project you just worked on.
...
b) Use `AskUserQuestion` to ask if the user would like to help improve Loop by opening a GitHub issue with these suggestions. Emphasize:
...
d) **If user agrees**:
   ...
   - If confirmed: run `gh issue create --repo FrankDan77/loop --title "..." --body "..."`
