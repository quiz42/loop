#!/usr/bin/env bash
#
# monitor-common.sh - Shared utilities for loop monitor functions
#
# This file contains common functions used by loop monitor functions.
# It should be sourced by loop.sh rather than executed directly.
