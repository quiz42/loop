...
# .loop/rlcr/2026-04-16_13-19-26/goal-tracker.md for authoritative list):
...
AC21B_DERIVED=$(
    ...
    source "$PROJECT_ROOT/hooks/lib/loop-common.sh"
    export TZ="UTC"
    derive_loop_start_iso_ts "/tmp/.loop/rlcr/2026-03-01_00-00-00"
)
...
AC21D_DERIVED=$(
    ...
    derive_loop_start_iso_ts "/tmp/.loop/rlcr/2026-03-01_09-00-00"
)
...
AC22_LOOP="$AC22_REPO/.loop/rlcr/2026-03-01_00-00-00"
