...
mkdir -p "$TEST_DIR/round0/.loop/rlcr/2026-01-19_00-00-00"
create_full_state "$TEST_DIR/round0/.loop/rlcr/2026-01-19_00-00-00" 0

set +e
parse_state_file_strict "$TEST_DIR/round0/.loop/rlcr/2026-01-19_00-00-00/state.md" 2>/dev/null
RESULT=$?
set -e
...
mkdir -p "$TEST_DIR/round5/.loop/rlcr/2026-01-19_00-00-00"
create_full_state "$TEST_DIR/round5/.loop/rlcr/2026-01-19_00-00-00" 5

ROUND=$(get_current_round "$TEST_DIR/round5/.loop/rlcr/2026-01-19_00-00-00/state.md")
if [[ "$ROUND" == "5" ]]; then
...
mkdir -p "$TEST_DIR/maxround/.loop/rlcr/2026-01-19_00-00-00"
create_full_state "$TEST_DIR/maxround/.loop/rlcr/2026-01-19_00-00-00" 42 42

ROUND=$(get_current_round "$TEST_DIR/maxround/.loop/rlcr/2026-01-19_00-00-00/state.md")
if [[ "$ROUND" == "42" ]]; then
...
mkdir -p "$TEST_DIR/finalize/.loop/rlcr/2026-01-19_00-00-00"
create_finalize_state "$TEST_DIR/finalize/.loop/rlcr/2026-01-19_00-00-00"

ACTIVE=$(find_active_loop "$TEST_DIR/finalize/.loop/rlcr" 2>/dev/null || echo "")
...
mkdir -p "$TEST_DIR/both/.loop/rlcr/2026-01-19_00-00-00"
create_full_state "$TEST_DIR/both/.loop/rlcr/2026-01-19_00-00-00" 5
create_finalize_state "$TEST_DIR/both/.loop/rlcr/2026-01-19_00-00-00" 10

# When both exist, finalize-state should be preferred
if [[ -f "$TEST_DIR/both/.loop/rlcr/2026-01-19_00-00-00/finalize-state.md" ]]; then
...
mkdir -p "$TEST_DIR/cancel/.loop/rlcr/2026-01-19_00-00-00"
create_cancel_state "$TEST_DIR/cancel/.loop/rlcr/2026-01-19_00-00-00"

ACTIVE=$(find_active_loop "$TEST_DIR/cancel/.loop/rlcr" 2>/dev/null || echo "")
if [[ -z "$ACTIVE" ]]; then
...
mkdir -p "$TEST_DIR/aftercancel/.loop/rlcr/2026-01-19_00-00-00"
create_cancel_state "$TEST_DIR/aftercancel/.loop/rlcr/2026-01-19_00-00-00"
mkdir -p "$TEST_DIR/aftercancel/.loop/rlcr/2026-01-19_12-00-00"
create_full_state "$TEST_DIR/aftercancel/.loop/rlcr/2026-01-19_12-00-00" 0

ACTIVE=$(find_active_loop "$TEST_DIR/aftercancel/.loop/rlcr" 2>/dev/null || echo "")
...
mkdir -p "$TEST_DIR/negative/.loop/rlcr/2026-01-19_00-00-00"
cat > "$TEST_DIR/negative/.loop/rlcr/2026-01-19_00-00-00/state.md" << 'EOF'
---
current_round: -1
max_iterations: 42
plan_file: plan.md
...
ROUND=$(get_current_round "$TEST_DIR/negative/.loop/rlcr/2026-01-19_00-00-00/state.md")
if [[ "$ROUND" == "-1" ]]; then
...
mkdir -p "$TEST_DIR/exceed/.loop/rlcr/2026-01-19_00-00-00"
cat > "$TEST_DIR/exceed/.loop/rlcr/2026-01-19_00-00-00/state.md" << 'EOF'
---
current_round: 100
max_iterations: 42
plan_file: plan.md
...
ROUND=$(get_current_round "$TEST_DIR/exceed/.loop/rlcr/2026-01-19_00-00-00/state.md")
if [[ "$ROUND" == "100" ]]; then
...
mkdir -p "$TEST_DIR/nonnumeric/.loop/rlcr/2026-01-19_00-00-00"
cat > "$TEST_DIR/nonnumeric/.loop/rlcr/2026-01-19_00-00-00/state.md" << 'EOF'
---
current_round: abc
max_iterations: 42
plan_file: plan.md
...
set +e
parse_state_file_strict "$TEST_DIR/nonnumeric/.loop/rlcr/2026-01-19_00-00-00/state.md" 2>/dev/null
RESULT=$?
set -e
...
mkdir -p "$TEST_DIR/nocurrent/.loop/rlcr/2026-01-19_00-00-00"
cat > "$TEST_DIR/nocurrent/.loop/rlcr/2026-01-19_00-00-00/state.md" << 'EOF'
---
max_iterations: 42
plan_file: plan.md
base_branch: main
...
set +e
parse_state_file_strict "$TEST_DIR/nocurrent/.loop/rlcr/2026-01-19_00-00-00/state.md" 2>/dev/null
RESULT=$?
set -e
...
mkdir -p "$TEST_DIR/nomax/.loop/rlcr/2026-01-19_00-00-00"
cat > "$TEST_DIR/nomax/.loop/rlcr/2026-01-19_00-00-00/state.md" << 'EOF'
---
current_round: 0
plan_file: plan.md
base_branch: main
...
set +e
parse_state_file_strict "$TEST_DIR/nomax/.loop/rlcr/2026-01-19_00-00-00/state.md" 2>/dev/null
RESULT=$?
set -e
...
mkdir -p "$TEST_DIR/nobase/.loop/rlcr/2026-01-19_00-00-00"
cat > "$TEST_DIR/nobase/.loop/rlcr/2026-01-19_00-00-00/state.md" << 'EOF'
---
current_round: 0
max_iterations: 42
plan_file: plan.md
...
set +e
parse_state_file_strict "$TEST_DIR/nobase/.loop/rlcr/2026-01-19_00-00-00/state.md" 2>/dev/null
RESULT=$?
set -e
...
mkdir -p "$TEST_DIR/multi/.loop/rlcr/2026-01-10_00-00-00"
mkdir -p "$TEST_DIR/multi/.loop/rlcr/2026-01-20_00-00-00"
mkdir -p "$TEST_DIR/multi/.loop/rlcr/2026-01-15_00-00-00"
create_full_state "$TEST_DIR/multi/.loop/rlcr/2026-01-20_00-00-00" 3

ACTIVE=$(find_active_loop "$TEST_DIR/multi/.loop/rlcr" 2>/dev/null || echo "")
...
mkdir -p "$TEST_DIR/invalid/.loop/rlcr/2026-01-19_00-00-00"
create_full_state "$TEST_DIR/invalid/.loop/rlcr/2026-01-19_00-00-00" 0
mkdir -p "$TEST_DIR/invalid/.loop/rlcr/2025-01-01_00-00-00"
create_full_state "$TEST_DIR/invalid/.loop/rlcr/2025-01-01_00-00-00" 1

ACTIVE=$(find_active_loop "$TEST_DIR/invalid/.loop/rlcr" 2>/dev/null || echo "")
...
mkdir -p "$TEST_DIR/wrongloc/.loop/rlcr/2026-01-19_00-00-00/subdir"
create_full_state "$TEST_DIR/wrongloc/.loop/rlcr/2026-01-19_00-00-00/subdir" 0
# No state.md in the expected location

ACTIVE=$(find_active_loop "$TEST_DIR/wrongloc/.loop/rlcr" 2>/dev/null || echo "")
