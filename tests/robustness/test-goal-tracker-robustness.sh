...
#
# Tests production loop_parse_goal_tracker function from scripts/loop.sh:
...
# Source test helpers first (before loop.sh which may use variables)
source "$SCRIPT_DIR/../test-helpers.sh"

# Source the production loop.sh to get loop_parse_goal_tracker function
...
# Uses looploop_parse_goal_tracker from scripts/loop.sh (sourced above)
...
RESULT=$(loop_parse_goal_tracker "$TEST_DIR/goal-tracker.md")
...
RESULT=$(loop_parse_goal_tracker "$TEST_DIR/goal-tracker-table.md")
TOTAL_ACS=$(parse_result "$RESULT" total_acs)
if [[ "$TOTAL_ACS" == "3" ]]; then
...
RESULT=$(loop_parse_goal_tracker "$TEST_DIR/goal-tracker-tasks.md")
...
RESULT=$(loop_parse_goal_tracker "$TEST_DIR/goal-tracker-completed.md")
...
RESULT=$(loop_parse_goal_tracker "$TEST_DIR/goal-tracker-goal.md")
...
RESULT=$(loop_parse_goal_tracker "$TEST_DIR/nonexistent.md")
...
RESULT=$(loop_parse_goal_tracker "$TEST_DIR/goal-tracker-empty.md")
TOTAL_ACS=$(parse_result "$RESULT" total_acs)
if [[ "$TOTAL_ACS" == "0" ]]; then
...
RESULT=$(loop_parse_goal_tracker "$TEST_DIR/goal-tracker-large.md")
TOTAL_ACS=$(parse_result "$RESULT" total_acs)
...
RESULT=$(loop_parse_goal_tracker "$TEST_DIR/goal-tracker-special.md")
TOTAL_ACS=$(parse_result "$RESULT" total_acs)
if [[ "$TOTAL_ACS" == "3" ]]; then
...
RESULT=$(loop_parse_goal_tracker "$TEST_DIR/goal-tracker-malformed.md")
TOTAL_ACS=$(parse_result "$RESULT" total_acs)
...
RESULT=$(loop_parse_goal_tracker "$TEST_DIR/goal-tracker-truncated.md")
TOTAL_ACS=$(parse_result "$RESULT" total_acs)
...
RESULT=$(loop_parse_goal_tracker "$TEST_DIR/goal-tracker-binary.md")
TOTAL_ACS=$(parse_result "$RESULT" total_acs)
if [[ "$TOTAL_ACS" -ge "1" ]]; then
...
RESULT=$(loop_parse_goal_tracker "$TEST_DIR/goal-tracker-issues.md")
...
RESULT=$(loop_parse_goal_tracker "$TEST_DIR/goal-tracker-deferred.md")
...
ISSUE_RESULT=$(loop_parse_goal_tracker_issue_counts "$TEST_DIR/goal-tracker-issue-breakdown.md")
...
ISSUE_RESULT=$(loop_parse_goal_tracker_issue_counts "$TEST_DIR/goal-tracker-issues.md")
BLOCKING_ISSUES=$(parse_issue_result "$ISSUE_RESULT" blocking_issues)
QUEUED_ISSUES=$(parse_issue_result "$ISSUE_RESULT" queued_issues)
OPEN_ISSUES=$(parse_issue_result "$ISSUE_RESULT" open_issues)
...
RESULT=$(loop_parse_goal_tracker "$TEST_DIR/goal-tracker-headers.md")
TOTAL_ACS=$(parse_result "$RESULT" total_acs)
ACTIVE_TASKS=$(parse_result "$RESULT" active_tasks)
...
RESULT=$(loop_parse_goal_tracker "$TEST_DIR/goal-tracker-mixed.md")
TOTAL_ACS=$(parse_result "$RESULT" total_acs)
...
RESULT=$(loop_parse_goal_tracker "$TEST_DIR/goal-tracker-longgoal.md")
GOAL=$(parse_result "$RESULT" goal_summary)
GOAL_LEN=${#GOAL}
