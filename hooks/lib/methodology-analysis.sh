...
complete_methodology_analysis() {
    python3 "$_HUMANIZE_HOOK_LIB_DIR/methodology_analysis.py" complete "$LOOP_DIR"
}

block_methodology_analysis_incomplete() {
    python3 "$_HUMANIZE_HOOK_LIB_DIR/methodology_analysis.py" block-incomplete "$LOOP_DIR"
}
